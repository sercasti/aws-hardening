...
- Disable Regions your business should never use (https://github.com/aws-samples/service-control-policy-examples/tree/main/Region-controls)
- Disable instance types your business should never use (https://github.com/aws-samples/service-control-policy-examples/blob/main/Service-specific-controls/Amazon-EC2/Require-Amazon-EC2-instances-to-use-a-specific-type.json)
